...
export default function InvoicePreview() {
  ...
  return (
    <div className="bg-black flex justify-center py-20 flex-col items-center">
      ...
      >
        ...
        <div className="absolute top-[120px] right-[80px] text-right">
          ...
          <p>
            <span className="text-[#d4af37]">NO.</span>{" "}
        ...
        <div className="absolute top-[300px] left-[500px]">
          <p className="text-xs tracking-[4px] text-[#d4af37] mb-3">
            BILL TO
          </p>
        ...
        <div className="absolute top-[590px] left-[80px] right-[80px] space-y-3">
          {invoice.items?.map((item, i) => (
            <div key={i} className="flex justify-between">
              ...
              <span>
                {(item.qty * item.price).toFixed(2)} THB
              </span>
            </div>
          ))}
        </div>
